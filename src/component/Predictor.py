...
from src.entity.entity import PredictorConfig
...
class Predictor:
    def __init__(self, config: PredictorConfig):
        self.transform=joblib.load(config.TRANSFORM_PATH)
        self.model=torch.load(config.MODEL_PATH,weights_only=False)
        self.model.eval()
